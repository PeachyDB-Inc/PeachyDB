...
After 1) and 2) above we are now ready to issue commands 3) through 12) to manage PeachyDB Server and Client Stacks. These commands are executed on the Monitor Instance obtained in step 2) above.<br>
