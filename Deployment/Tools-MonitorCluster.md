...
1. As explained in <a href="">monitor instance</a>, the monitoring instance is the instance from which AWS cloud formation stacks are created and deleted. This is the instance from which the monitoring commands will be issued. From the monitoring instance utilize <code>peachydb_status_tool</code> for various usages.
