...
Once the Client Instance is available we can now Add/Remove/Substitute instances to the Server Stack. As a prerequisite please carefully read setions in <a href="https://github.com/akseg73/PeachyDB/tree/main" title="Documentation"> Readme</a> to understand numerous issue.
