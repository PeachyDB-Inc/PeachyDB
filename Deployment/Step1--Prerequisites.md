...
To get started its probably more convenient to auto-generate the security group, subnet (with auto generate CIDR block) with the specified VPC, as well as S3 bucket. The security group, subnet will be created with tags and any subsequent creation of stacks will attempt to lookup these resources by tags and reutilize them.
