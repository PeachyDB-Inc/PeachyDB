...
___IMPORTANT:___ Each AWS EC2 client Instance must run only a single client driver. Multiple Client drivers running on a single AWS EC2 Instance is not supported. The Client driver is multi-threaded.
