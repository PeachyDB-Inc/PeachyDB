...
<details>
  ...
  <b>16.b</b><code>peachydb_modify_server_stack</code>: to modify server AWS Cloudformation stack. Modifying server stack is a database transaction and hence must be submitted from a client instance in the client AWS cloudformation stack. The tool does not have to be directly invoked python scripts are available which serve as wrapper on the tool to perform the tasks needed.<br><br>
