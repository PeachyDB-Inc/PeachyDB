...
<details>
  ...
  <ul>
    ...
    <li>1.f) Adding/Dropping Secondary Indexes, Tables are also time consuming operations and will significantly degrade online write performance. It is best that such operations are undertaken at quiescent point, with low write activity.</li>
