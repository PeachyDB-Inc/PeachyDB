...
<details>
  ...
  <b>16.a</b><code>peachydb_cluster_tool</code>: to utilize for create/delete/describe server and client AWS Cloudformation Stacks. It is also utilized to modify (adding removing instances) client stacks. This tool is executed on the Control Unit.<br><br>
  <b>16.b</b><code>peachy_modify_server_stack</code>: to utilize to modify server AWS Cloudformation stack. Modifying server stack is a database transaction and hence must be submitted from a client instance.<br><br>
