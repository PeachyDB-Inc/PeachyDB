...
<details>
  ...
  <br>
  The <code>peachydb_status_tool</code> can be utilized to obtain liveness information of the servers in the server AWS CloudFormation Stack. The <a href="https://github.com/PeachyDB-Inc/PeachyDB/blob/main/Deployment/Tools-MonitorCluster.md"> monitor servers </a> explains how to issue commands to monitor the health of the server clusters.
  <br><br>
