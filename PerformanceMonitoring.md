...
## Client Performance
The client is typically multi-threaded. During testing phase, you can track CPU utilization on the client with 'top' in a separate shell to see
...
utilization, it may be better to add additional AWS client instances to drive more load to underutilized database servers.
