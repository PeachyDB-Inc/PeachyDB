...
- fibers perform better than threads for client driver so long as co-operative scheduling is respected. A quick review of this can be obtained at <a href="https://boost.org/doc/libs/1_85_0/libs/fiber/doc/html/index.html">boost c++ fibers </a>. It requires understanding of a few basic concepts which can be useful regardless of our product.
