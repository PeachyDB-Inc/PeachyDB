...
- **28.b)** **Caution**: As indicated in our license, the product is provided as is and we are not responsible for any losses that may occur due to utilizing this product. We will not accept any form of litigation for any issues. To minimize your risk please test your use case thoroughly. You will likely find the product exceeds your expectations for the use cases it is designed for. Quality is of utmost importance to us, however due to the nature of software it is impossible to not have some issues.
