...
long running reads/writes to be transactional. Long running reads are allowed but are not transactional. Long running writes can not be a single transaction.
