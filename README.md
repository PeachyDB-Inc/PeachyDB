...
**Prerequisite**: Please read <a href="https://cassandra.apache.org/doc/latest/" title="Documentation"> Apache Cassandra CQL documentation </a> to understand the below.
...
- **25.j)** A single database record is currently limited to 1MB in size.
