...
- **6.e)** Write transactions utilize distributed consensus (raft protocol), as a result, the database will become unavailable for writes if the majority of the coordinator nodes are down. This is the price to pay for consistency. Some of this is mitigated with a larger number of coordinator nodes.
