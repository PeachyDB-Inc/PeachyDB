...
Each AWS EC2 Instance must run only a single client program, which can utilize multiple threads/fibers as in the provided example. The Clients utilize a default number of threads based upon the capability of the EC2 Instance, however they have not been tuned best to your application, you can make measurements with fewer and more threads to determine the best performance. Maximum threads on a client is 255.
