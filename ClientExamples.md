...
Each AWS EC2 Instance must run only a single client program. This is true of any clients whether this example or any other the customer might write. Client programs can utilize multiple threads/fibers as in the provided example. The Clients utilize a default number of threads based upon the capability of the EC2 Instance, however they have not been tuned best to your application, you can make measurements with different number of threads to determine what works best for your case. Maximum threads on a client is 255.
